...
def test_extract_street_num1():
    address = Address('1', '', 'Los Angeles', 'CA', '12345')
    with pytest.raises(Exception):
        address.extract_street_num()

def test_extract_street_num2():
    address = Address('1', None, 'Los Angeles', 'CA', '12345')
    with pytest.raises(Exception):
        address.extract_street_num()
...
def test_eq1():
    address1 = Address('1', '123 main street', 'Los Angeles', 'CA', '12345')
    address2 = Address('1', '123 main street', 'Los Angeles', 'CA', '12345')
    assert address1 == address2

def test_eq2():
    address1 = Address('1', '123 main street', 'Los Angeles', 'CA', '12345')
    address2 = Address('1', '23 main street', 'Los Angeles', 'CA', '12345')
    assert address1 != address2

def test_eq3():
    address1 = Address('1', '123 main street', 'Los Angeles', 'CA', '12345')
    address2 = Address('2', '123 main street', 'Los Angeles', 'CA', '12345')
    assert address1 != address2