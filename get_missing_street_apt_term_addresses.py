...
def main(argv):
   ...
   try:
      ...
      print("get_missing_street_apt_term_addresses.py -i <inputfile> -o <outputfile>")
      sys.exit(2)
   for opt, arg in opts:
      if opt == "-h":
         print("get_missing_street_apt_term_addresses.py -i <inputfile> -o <outputfile>")
   ...
   missing_street_apt_term_addresses = []
   fields = []
   with open(inputfile) as csvfile:
       ...
       for row in csvreader:
           ...
           if (os1.missing_street_apt_term(address)):
               missing_street_apt_term_addresses.append(row)
    
   with open(outputfile, 'w') as csvfile:
       csvwriter = csv.writer(csvfile)
       csvwriter.writerow(fileds)
       csvwriter.writerows(missing_street_apt_term_addresses)
